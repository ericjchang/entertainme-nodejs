...
import { FETCH_TV_SERIAL, UPDATE_TV_SERIES } from '../queries/tv';
...
export default () => {
  ...
  const [actionUpdate] = useMutation(UPDATE_TV_SERIES, {
    refetchQueries: [
      {
        query: FETCH_ALL,
      },
